...
public class ArticleCategoryConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component,
		...
		try {
			return getBaseService(context).getObject(ArticleCategory.class, Long.parseLong(value));
		...
		if (value instanceof ArticleCategory) {
			...
			if (articleCategory.getId() == null)
				throw new IllegalArgumentException(
						"Cannot convert ArticleCategory object with null id.");
			return articleCategory.getId().toString();
		} else {
			return "";
		}
	}
